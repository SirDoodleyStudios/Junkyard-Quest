...
public abstract class BaseScriptJigAbi : ScriptableObject
{
    ...
    //public virtual JigsawLink inputLink { get; }
    //public virtual JigsawLink outputLink { get; }

    //public virtual AllJigsaws enumJigsawName { get; }

    public void GetInheritedLinks()
    {
